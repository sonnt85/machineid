...
[![Go Reference](https://pkg.go.dev/badge/github.com/sonnt85/machineid.svg)](https://pkg.go.dev/github.com/sonnt85/machineid)

![Image of Gopher 47](logo.png)

… because sometimes you just need to reliably identify your machines.

[![GoDoc](https://godoc.org/github.com/sonnt85/machineid?status.svg)](https://godoc.org/github.com/sonnt85/machineid) [![Go Report Card](https://goreportcard.com/badge/github.com/sonnt85/machineid)](https://goreportcard.com/report/github.com/sonnt85/machineid)
...
```bash
go get github.com/sonnt85/machineid
```

You can also add the cli app directly to your `$GOPATH/bin` with

```bash
go get github.com/sonnt85/machineid/cmd/machineid
```
